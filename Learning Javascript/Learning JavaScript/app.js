 Javascript is responsible for adding interactivity and functionality to a webpage. 
 i need to know the diff syntax(s) to be used for implementing diff functionalities on a webpage i.e knowing when to use use 
console.log("Hello World")
alert (My name is Osariemen)

// DATA TYPES
// -String e.g 'boy',"girl"
// -Number e.g 1, 2.3,4,
// -Boolean: are true or false values
// -Array: are identified by squared brackets. e.g []
// -Arrays can take all the others types of Data. you can have String, number, boolean and even an array inside an array.
// -Objects: identified by curly braces
// {} and they are made up of 'key-value' pairs 
// -Null: means a value should be empty by default. thus the null variable can be any of the types of data. 
// -Undefined- no equal to(=), just semi-colon



// // Variables are storage mediums that can assume any form
...
// let is local; meaning it is only accessible within  locality of where its been declared

// // Declaring var using const
